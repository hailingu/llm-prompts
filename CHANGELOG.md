...
- Commit: https://github.com/hailingu/llm-prompts/commit/3cd194d
...
- Commit: https://github.com/hailingu/llm-prompts/commit/e24901f

### 6022f20

- docs(go-standards): 修复 MD036/MD001（将斜体用作标题的行替换为真实标题并修正标题等级），并为 `go-standards/effective-go-guidelines.md` 补充简短说明以提高可读性。
- Commit: https://github.com/hailingu/llm-prompts/commit/6022f20

### 8cecdec

- docs(go-standards): 微调并补充文档说明，改善示例和格式（MD036 修复系列之一）。
- Commit: https://github.com/hailingu/llm-prompts/commit/8cecdec

### 200a373

- fix(docs): 将多处示例的强调替换为真实标题以修复 MD036（if-statement 指南）。
- Commit: https://github.com/hailingu/llm-prompts/commit/200a373

### 33ed4cc

- fix(docs): 将包注释中的强调替换为标题（MD036 修复）。
- Commit: https://github.com/hailingu/llm-prompts/commit/33ed4cc

### a3b69a9

- fix(docs): 将缩进与示例中的强调替换为标题（MD036 修复）。
- Commit: https://github.com/hailingu/llm-prompts/commit/a3b69a9

### 2d35d81

- fix(docs): 修复行长示例中使用强调作为标题的问题（MD036 修复）。
- Commit: https://github.com/hailingu/llm-prompts/commit/2d35d81
...
- Commit: https://github.com/hailingu/llm-prompts/commit/9ddd9ce
...
- 将 git 提交提示翻译为英文
- 添加 `.gitmessage` 提交模板（含英文注释與示例，列出提交类型及其中文含义）
...
- Commit: https://github.com/hailingu/llm-prompts/commit/c7f16bd
