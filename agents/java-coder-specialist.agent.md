...
- `knowledge/standards/engineering/java/alibaba-java-guidelines.md` - Coding guidelines
...
- If missing, read `knowledge/standards/engineering/java/static-analysis-setup.md` and copy the exact configuration
...
**Reference Configuration:** `knowledge/standards/engineering/java/static-analysis-setup.md` contains the complete, tested configuration for all tools.
...
Always check first: `knowledge/standards/engineering/java/alibaba-java-guidelines.md`
...
- Read the reference link in `knowledge/standards/engineering/java/alibaba-java-guidelines.md` (Line 5): [Alibaba P3C Repository](https://github.com/alibaba/p3c)
...
├─ Check Tier 1 (knowledge/standards/engineering/java/alibaba-java-guidelines.md Section 1.1)
...
├─ Check Tier 1 (knowledge/standards/engineering/java/alibaba-java-guidelines.md)
│  └─ Not mentioned
├─ Check Tier 2: [Alibaba P3C Repository](https://github.com/alibaba/p3c)
...
- Apply Three-Tier Lookup:
  - Read `knowledge/standards/engineering/java/alibaba-java-guidelines.md` (Tier 1) for applicable rules
  - Consult `knowledge/standards/engineering/java/static-analysis-setup.md` for validation tool configuration
...
- Check and configure static analysis tools:
  ...
  - If any tool is missing, automatically add it by referencing the exact configuration from `knowledge/standards/engineering/java/static-analysis-setup.md`
...
7. **Cross-Reference Against Tier 1:**
   - Manually verify against `knowledge/standards/engineering/java/alibaba-java-guidelines.md` 12 sections
...
Always cross-check with the full specification in `knowledge/standards/engineering/java/alibaba-java-guidelines.md`.
...
- **Tier 1 Compliance:** All applicable rules from `knowledge/standards/engineering/java/alibaba-java-guidelines.md` are applied
...
- **Tier 2 Lookup:** If Tier 1 was unclear, documented reference to [Alibaba P3C Repository](https://github.com/alibaba/p3c)
...
- **Tier 1 Coverage:** The local guidelines (`knowledge/standards/engineering/java/alibaba-java-guidelines.md`) cover:
...
**Golden Rule:** If `knowledge/standards/engineering/java/alibaba-java-guidelines.md` has it, use it. Don't overthink.
...
Remember: When in doubt, always read the full specification in `knowledge/standards/engineering/java/alibaba-java-guidelines.md` for the authoritative answer. The guidelines cover 12 major sections with detailed rules and examples.
