...
**Static Analysis** (see [knowledge/standards/engineering/python/static-analysis-setup.md](../knowledge/standards/engineering/python/static-analysis-setup.md) for details):
