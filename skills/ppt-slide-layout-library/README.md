...
| `layout_budget_profiles` | **[NEW]** 可执行布局预算档案（高度/间距/数量上限） | 8 |
...
| 3 | 仪表盘网格 | `dashboard_grid` | **[NEW]** 多维KPI+趋势图组合，受控即兴排版 |
...
| 10 | 支柱型 | `pillar` | **[NEW]** Executive Summary，核心支柱，战略概览 |
| 11 | 流程型步骤 | `process_steps` | **[NEW]** 时间线，演变过程，Step 1-2-3 逻辑 |
| 12 | 对比型 | `comparison` | **[NEW]** 竞品分析，多维度对比 columns |
...
# 预算档案 → layouts.yml → layout_budget_profiles  <-- NEW: P0 Root Fix
