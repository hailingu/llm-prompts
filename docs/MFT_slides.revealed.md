...
## Slide 4: 市场概览
**Title**: 主要细分：EV 快充、SST、数据中心、轨道牵引
...
reveal_hint:
  ...
  chart_type: "diagram"
  alt_text: "器件→系统影响链（SiC/GaN → MFT → 系统性能）"
```
...
reveal_hint:
  layout: "two-column-6040"
  chart_type: "chart"
  alt_text: "损耗分解图（铁损/铜损/附加损耗）"
```



## Slide 12: 热管理策略
**Title**: 场景匹配：被动（低功率）→ 风冷/液冷（高功率）
...
reveal_hint:
  layout: "two-column-6040"
  chart_type: "chart"
  alt_text: "冷却方案对比（被动/风冷/液冷/嵌入式）"
```



## Slide 13: 绝缘与局放控制
**Title**: 局放检测、老化试验与制造工艺控制
...
## Slide 15: 制造及质量一致性
**Title**: 关键过程：绕组、浸漆、固化、装配的 SPC 控制
...
reveal_hint:
  layout: "chart-focused"
  chart_type: "diagram"
  alt_text: "量产工艺控制流程（绕组→浸漆→固化→测试→放行）"
```
...
reveal_hint:
  layout: "chart-focused"
  chart_type: "diagram"
  alt_text: "示范数据流：设计→样机→现场→数据→标准"
```



## Slide 18: 仿真与样机验证流程
**Title**: 仿真先行→样机迭代→现场示范验证
...
**Title**: KPI：p95 延时、效率、PD 事件率、MTBF
...
reveal_hint:
  layout: "chart-focused"
  chart_type: "diagram"
  alt_text: "示范 KPI 仪表盘样例"
```



## Slide 20: 商业模式与服务化路径
**Title**: 试点付费模式、安装服务与运维订阅
...
reveal_hint:
  layout: "full-bleed"
  chart_type: "table"
  alt_text: "商业模式画布（硬件/服务/收费点）"
```



## Slide 21: 成本构成与 ROI 敏感性
**Title**: 主要成本驱动：磁芯、工艺、测试与质保
...
reveal_hint:
  layout: "full-bleed"
  chart_type: "table"
  alt_text: "风险矩阵（概率 vs 影响）"
```



## Slide 25: 项目组织与治理模型
**Title**: 建议组织：项目赞助人→PMO→技术小组→供应链
...
reveal_hint:
  layout: "chart-focused"
  chart_type: "diagram"
  alt_text: "12–18 个月扩展甘特图"
```



## Slide 29: 预算请求与投资回报概览
**Title**: 首轮预算区间、主要开支项、预期里程回收
...
**Title**: 参考：将补充 >=12 篇带 DOI 的学术论文与示范链接
