...
`md-table-fixer` provides an automated, display-width-aware toolset for detecting and fixing Markdown table alignment issues (MD060). It handles CJK characters correctly and creates `.bak` files for any modified documents.
...
1. `run_in_terminal: python3 tools/md_table_tool.py detect templates/`
