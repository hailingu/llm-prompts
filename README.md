...
├── knowledge/standards/common/          # Cross-language standards
├── knowledge/standards/engineering/java/     # Java-specific guidelines
├── knowledge/standards/engineering/go/       # Go-specific guidelines
├── knowledge/standards/engineering/python/   # Python-specific guidelines
└── knowledge/templates/          # Reusable document templates
```
